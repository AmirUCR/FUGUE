Run the following to install the diamond conda environment:

conda create -n diamond -c bioconda diamond

Also create the allegro environment according to the instructions on GitHub.

Run 0_just_run_this.sh and when it's done, run all cells in 5_analysis_missing_orthologs.ipynb
